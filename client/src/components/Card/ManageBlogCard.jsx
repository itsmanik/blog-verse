...
const ManageBlogCard = ({ blog }) => {
  ...
  return (
    <div>
      <div className="flex flex-col h-[29rem] justify-between overflow-hidden cursor-pointer max-w-lg p-6 space-y-6 rounded-lg shadow-md bg-[#1e1e1e] text-[#cecece]">
        <div>
          <div className="mt-5">
            <img
            ...
            <AlertDialog.Root>
              ...
              <AlertDialog.Content maxWidth="450px">
                ...
                <AlertDialog.Description size="2">
                  Are you sure? This blog will be permanently deleted.
