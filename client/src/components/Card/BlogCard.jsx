const BlogCard = ({ blog }) => {
  return (
    <div>
      <div class="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-[#1e1e1e] text-[#cecece]">
        <div class="flex space-x-4">
          ...
          <div class="flex flex-col space-y-1">
            ...
            <span class="text-xs text-gray-600">4 hours ago</span>
          </div>
        </div>
        <div>
          <img
            ...
            alt=""
            class="object-cover w-full mb-4 h-60 sm:h-40 bg-gray-300"
          />
          <h2 class="mb-1 text-xl font-semibold text-[#c6c6c6]">{blog.title}</h2>
          ...
          <div class="space-x-2">
            ...
            >
              <svg
                ...
                viewBox="0 0 512 512"
                class="w-4 h-4 fill-current text-violet-600"
              >
